...
async def brightcove(bot, update):
    ...
    if uri == 404:
        return
    uri = "https://www.blackdrive.tk/brightcove?id=" + uri
...
async def jwplayer_(bot, update):
    ...
    if uri == 404:
        return
    uri = "https://www.blackdrive.tk/jw?id=" + uri
    await update.reply_text(text="Use the below url to stream in website",
                            reply_markup=InlineKeyboardMarkup(
                                    [[
                                        InlineKeyboardButton("Stream", url=uri)
...
async def yt__(bot, update):
    ...
    if uri == 404:
        return
    uri = "https://www.blackdrive.tk/yt?id=" + uri
    await update.reply_text(text="Use the below url to stream in website",
                            reply_markup=InlineKeyboardMarkup(
                                    [[
                                        InlineKeyboardButton("Stream", url=uri)
...
async def m3u8_(bot, update):
    ...
    if uri == 404:
        return
    uri = "https://www.blackdrive.tk/m3u8?id=" + uri
    await update.reply_text(text="Use the below url to stream in website",
                            reply_markup=InlineKeyboardMarkup(
                                    [[
                                        InlineKeyboardButton("Stream", url=uri)
...
async def mpd_(bot, update):
    ...
    if uri == 404:
        return
    uri = "https://www.blackdrive.tk/mpd?id=" + uri
    await update.reply_text(text="Use the below url to stream in website",
                            reply_markup=InlineKeyboardMarkup(
                                    [[
                                        InlineKeyboardButton("Stream", url=uri)
...
async def direct_player_(bot, update):
    ...
    if uri == 404:
        return
    uri = "https://www.blackdrive.tk/play?id=" + uri
    await update.reply_text(text="Use the below url to stream in website",
                            reply_markup=InlineKeyboardMarkup(
                                    [[
                                        InlineKeyboardButton("Stream", url=uri)
