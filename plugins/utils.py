...
async def brightcove(bot, update):
    ...
    if uri == 404:
        return
    uri = "https://player-sidd.herokuapp.com/brightcove?id=" + uri
...
async def jwplayer_(bot, update):
    ...
    if uri == 404:
        return
    uri = "https://player-sidd.herokuapp.com/jw?id=" + uri
    await update.reply_text(text="Use the below url to stream in website",
                            reply_markup=InlineKeyboardMarkup(
                                    [[
                                        InlineKeyboardButton("Stream", url=uri)
...
async def yt__(bot, update):
    ...
    if uri == 404:
        return
    uri = "https://player-sidd.herokuapp.com/yt?id=" + uri
    await update.reply_text(text="Use the below url to stream in website",
                            reply_markup=InlineKeyboardMarkup(
                                    [[
                                        InlineKeyboardButton("Stream", url=uri)
...
async def m3u8_(bot, update):
    ...
    if uri == 404:
        return
    uri = "https://player-sidd.herokuapp.com/m3u8?id=" + uri
    await update.reply_text(text="Use the below url to stream in website",
                            reply_markup=InlineKeyboardMarkup(
                                    [[
                                        InlineKeyboardButton("Stream", url=uri)
...
async def mpd_(bot, update):
    ...
    if uri == 404:
        return
    uri = "https://player-sidd.herokuapp.com/mpd?id=" + uri
    await update.reply_text(text="Use the below url to stream in website",
                            reply_markup=InlineKeyboardMarkup(
                                    [[
                                        InlineKeyboardButton("Stream", url=uri)
...
async def direct_player_(bot, update):
    ...
    if uri == 404:
        return
    uri = "https://player-sidd.herokuapp.com/play?id=" + uri
    await update.reply_text(text="Use the below url to stream in website",
                            reply_markup=InlineKeyboardMarkup(
                                    [[
                                        InlineKeyboardButton("Stream", url=uri)
